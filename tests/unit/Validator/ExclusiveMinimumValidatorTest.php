...
use Mcustiel\SimpleRequest\Validator\ExclusiveMinimum;

class ExclusiveMinimumValidatorTest extends \PHPUnit_Framework_TestCase
{
    private $validator;

    public function setUp()
    {
        $this->validator = new ExclusiveMinimum();
    }

    /**
     * @test
     * @expectedException \Mcustiel\SimpleRequest\Exception\UnspecifiedValidatorException
     * @expectedExceptionMessage The validator ExclusiveMinimum is being initialized without a valid number
     */
    ...
    public function testValidationWithIntegers()
    {
        ...
        $this->assertTrue($this->validator->validate(400));
