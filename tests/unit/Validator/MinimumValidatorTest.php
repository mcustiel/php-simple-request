...
class MinimumValidatorTest extends \PHPUnit_Framework_TestCase
{
    private $validator;

    public function setUp()
    {
        $this->validator = new Minimum();
    }

    /**
     * @test
     * @expectedException \Mcustiel\SimpleRequest\Exception\UnspecifiedValidatorException
     * @expectedExceptionMessage The validator Minimum is being initialized without a valid number
     */
    ...
    public function testValidationWithIntegers()
    {
        ...
        $this->assertFalse($this->validator->validate(4));
